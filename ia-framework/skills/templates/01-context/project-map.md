...
| `src/react/src/features/<feature>/` | react | page + view + hooks + store por feature |
...
- Novo teste e2e frontend → `src/frontend/e2e/` ou `src/react/e2e/` (Playwright), não dentro
  de feature.
